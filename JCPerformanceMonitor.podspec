#
# Be sure to run `pod lib lint JCPerformanceMonitor.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'JCPerformanceMonitor/Classes/**/*'
  
  # s.resource_bundles = {
  #   'JCPerformanceMonitor' => ['JCPerformanceMonitor/Assets/*.png']
  # }
